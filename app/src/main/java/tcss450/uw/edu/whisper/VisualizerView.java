 ...
 * Code Courtesy of https://www.codota.com/android/scenarios/52fcbcafda0ac35e3dddac0e/android.media.audiofx.Visualizer?tag=dragonfly&afterAuth=%2Fandroid%2Fscenarios%2F52fcbcafda0ac35e3dddac0e%2Fandroid.media.audiofx.Visualizer%3Ftag%3Ddragonfly%26fullSource%3D1&fullSource=1&cbSnippetSaved=1
 */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mFFTBytes != null) {
            ...
            try {
                ...
                Bitmap bmp = BitmapFactory.decodeResource(getResources(), this.getId());
